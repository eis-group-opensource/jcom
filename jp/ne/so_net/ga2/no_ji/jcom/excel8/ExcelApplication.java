...
//	}
//
	public String Caption() throws JComException { return (String)get("Caption"); }
...
//	}
	...
	public void Caption(String newValue) throws JComException { put("Caption", newValue); }
...
//	}
//
//	VARIANT _Application::InputBox(LPCTSTR Prompt, const VARIANT& Title, const VARIANT& Default, const VARIANT& Left, const VARIANT& Top, const VARIANT& HelpFile, const VARIANT& HelpContextID, const VAR//IANT& Type)
//	{
//	VARIANT result;
//	static BYTE parms[] =
...
//	}
	...
	public void Quit() throws JComException { method("Quit", null); }
...
//
	...
	public void SaveWorkspace(String Filename) throws JComException {
		Object[] arglist = new Object[1];
		arglist[0] = Filename;
		method("SaveWorkspace", arglist);
	}
...
//	}
//
	public String UserName() throws JComException { return (String)get("UserName"); }
...
//	}
	...
	public void UserName(String newValue) throws JComException { put("UserName", newValue); }
...
//	}
	...
	public String Value() throws JComException { return (String)get("Value"); }
...
//	}
//
	public String Version() throws JComException { return (String)get("Version"); }
